...
{
	// Does not clear the renderer: Application::Run() already clears once at
	// the top of the frame, before any Layer::OnRender() call -- clearing
	// again here would wipe out whatever layers (e.g. WorldLayer's tile
	// rendering) drew before this GUI pass runs.
