...
// convention as SocketComponent::fallback_prefab_id/RenderableComponent::
// texture_id) rather than a compile-time enum, so new races can be added or
// removed purely as data, with no engine recompile.
