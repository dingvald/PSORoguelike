...
- [ ] Editor menu should be centered
...
- [ ] Similar to sockets, there should be Spawns that can be set for spawn waves
- [ ] Give a warning for invalid references and a button to clean invalid references
