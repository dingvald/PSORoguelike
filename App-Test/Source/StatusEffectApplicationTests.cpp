...
{
    psr::StatusEffectLibrary library{{MakeEffect(1, psr::StatusEffectType::Freeze, /*magnitude=*/50, /*duration=*/3)}};
    psr::Registry registry;
    registry.BindSystemEvents<psr::HealthComponent, psr::HealthSystem>();
    registry.BindSystemEvents<psr::HealthComponent, psr::DeathSystem>();
    entt::entity handle = registry.CreateEntity();
...
{
    psr::StatusEffectLibrary library{{MakeEffect(1, psr::StatusEffectType::Poison, /*magnitude=*/999, /*duration=*/3)}};
    psr::Registry registry;
    registry.BindSystemEvents<psr::HealthComponent, psr::HealthSystem>();
    registry.BindSystemEvents<psr::HealthComponent, psr::DeathSystem>();
    entt::entity handle = registry.CreateEntity();
